...
resource "aws_instance" "kube-master" {
    ...
    key_name = "clarus"
    subnet_id = "subnet-0a414ddeefe3b3526"  # select own subnet_id of us-east-1a. worker ve master nodes hepsini ayni subnet e (az ye) koyariz, maliyeti azaltmak icin.
...
resource "aws_instance" "worker-1" {
    ...
    key_name = "clarus"
    subnet_id = "subnet-0a414ddeefe3b3526"  # select own subnet_id of us-east-1a
    availability_zone = "us-east-1a"
    tags = {
        Name = "worker-1"
        Project = "tera-kube-ans"
